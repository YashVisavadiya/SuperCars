...
const Footer = () => {
  ...
  return (
    <>
      <div className="container-fluid my-4" id="footer">
        <div className="container">
          <table className="table">
            <tbody>
              <tr className="row">
                <td className="footer-image col removeBorder" align="center">
                  <button
                    className="dark-font"
              ...
              <tr className="row dark-font" style={{ display: "flex" }}>
                <td className="col removeBorder" align="center">
                  <svg
              ...
              <tr className="row dark-font my-4">
                <td className="col removeBorder">
                  <button
                    className="dark-font"
                    style={{ background: "black", color: "#212529" }}
                    onClick={() => {
              ...
              <tr className="row dark-font my-2">
                <td className="col removeBorder" align="center">
                  <button
                    className="dark-font"
                    style={{ background: "black", color: "#212529" }}
              ...
              <tr className="row my-2 dark-font">
                <td className="col removeBorder" align="center">
                  &copy; 2022 SC
                </td>
              </tr>
